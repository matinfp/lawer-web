...
using Application.Models.CaseDto;
...
namespace Lawer.Controllers
{
    public class PaymentTestController : Controller
    {
        ...
        public PaymentTestController(IOnlinePayment onlinePayment, ICasesRepository casesRepository, ILawyerProfileRepository lawyerRepository, IMediator mediator)
        {
